    ...
    <div class="mb-4">
      <table class="font-noto mx-2 mt-4 shadow" v-for="item in data">
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr class="bg-red-100">
            <td class="py-2 border border-gray-400 px-4 text-yellow-400">
              <span v-if="shouldShowRedIcon(item)">
                <svg
            ...
            <td class="w-11/12 py-2 border border-gray-400 px-4">
              {{ item.Red.join(' / ') }}
            </td>
          </tr>
          <tr class="bg-blue-100">
            <td class="py-2 border border-gray-400 px-4 text-yellow-400">
              <span v-if="shouldShowBlueIcon(item)">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
          ...
          <tr class="bg-green-100">
            <td class="py-2 border border-gray-400 px-4 text-yellow-400">
              <span v-if="shouldShowGreenIcon(item)"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
