<template>
  <button
    type="button"
    @click="openModal"
    class="rounded-md bg-red-500 px-3 py-2 text-sm font-medium text-white hover:bg-black/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 mt-5"
  >
    重啟一局
  </button>
